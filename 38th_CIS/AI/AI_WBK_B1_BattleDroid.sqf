...
[_unitWithSword, selectRandom ["B1_DeathSound_1","B1_DeathSound_2","B1_DeathSound_3","B1_DeathSound_4","B1_DeathSound_5","B1_DeathSound_6","B1_DeathSound_7","B1_DeathSound_8","B1_DeathSound_9","B1_DeathSound_10"], 90, 10] execVM "\WebKnight_StarWars_Mechanic\createSoundGlobal.sqf";
...
[_this, selectRandom ["B1_hit_1","B1_hit_2","B1_hit_3","B1_hit_4","B1_hit_5","B1_hit_6","B1_hit_7","B1_hit_8","B1_hit_9"], 90] call CBA_fnc_globalSay3d;
sleep 10;
_this setVariable ["B1Speak",nil];
	...
	_rndAnim = selectRandom ["B1_Droid_hit_1","B1_Droid_hit_3"];
...
_this setVariable ["B1Speak",1];
[_this, selectRandom ["B1_shooting_1","B1_shooting_2","B1_shooting_3","B1_shooting_4","B1_shooting_5"], 60] call CBA_fnc_globalSay3d;
sleep (random 10);
_this setVariable ["B1Speak",nil];
};
};
